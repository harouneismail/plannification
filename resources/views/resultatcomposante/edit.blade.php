...
<div class="grid">
    <div class="container" style="margin-top:2%">
        ...
        <form action="{{ url('resultatcomposante/'.$resultatcomposante->id) }}" method="post">
            @csrf
                           ...
                           <div class="col form-group">
                               ...
                               <div class="form-group">
                                 <select name="axe_id" id="axe_id" class="form-control">
                                      <option value="{{$resultatcomposante->axe->id}}">{{$resultatcomposante->axe->name_axe}}</option>
                                ...
                                <div class="form-group">
                                    <select name="composante_id" id="composante_id" class="form-control">
                                        <option value="{{$resultatcomposante->composante->id}}">{{$resultatcomposante->composante->name_composante}}</option>
                                    </select>
                                  </div>
                                 ...
                                 <select name="souscomposante_id" id="souscomposante_id" class="form-control">
                                        <option value="{{$resultatcomposante->souscomposante->id}}">{{$resultatcomposante->souscomposante->name_souscomposante}}</option>
                                    </select>
                                  </div>
                                   ...
                                   <div class="col form-group">
                                    ...
                                    <div class="form-group">
                                    <input name="name_resultatcomposantes" id="name_resultatcomposantes" class="form-control" value="{{$resultatcomposante->name_resultatcomposantes}}">
           
                                   <div class="status-error">
                                           @if($errors->get('name_resultatcomposantes'))
                                           @foreach($errors->get('name_resultatcomposantes') as $message)
                                                       <li class="alert alert-danger">{{ $message }}</li>
                                                   @endforeach
                                       @endif
                                   </div>
                                   <div class="row">
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="cible_2025_2030" id="cible_2025_2030" class="form-control" value="{{$resultatcomposante->cible_2025_2030}}">
                                          </div>
                   
                                           <div class="status-error">
                                                   @if($errors->get('cible_2025_2030'))
                                                   @foreach($errors->get('cible_2025_2030') as $message)
                                                               <li class="alert alert-danger">{{ $message }}</li>
                                                           @endforeach
                                               @endif
                                           </div>
