...
<div class="grid">
    <div class="container" style="margin-top:2%">
        <div class="row bg-white shadow-sm">
            <h4 class="col display-4 text-center">Modifier un Type d'Activité</h4>
        </div>
         <form action="{{ url('typeactivite/'.$typeactivite->id) }}" method="post">
              @csrf
            ...
            <div class="container bg-white shadow-sm" style="margin-top:2%">
               <div class="row">
                   <div class="col form-group">
                       ...
                       <input type="text" name="name_typeactivites" id="name_typeactivites" class="form-control"  value="{{ $typeactivite->name_typeactivites }}">
