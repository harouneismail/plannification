...
<div class="grid">
    <div class="container" style="margin-top:2%">
        <div class="row bg-white shadow-sm">
            <h4 class="col display-4 text-center">Ajouter  un Niveau de Planification</h4>
        </div>
            ...
            <div class="container bg-white shadow-sm" style="margin-top:2%; padding-bottom:5%">
               <div class="row">
                   <div class="col form-group">
                       ...
                       <div class="form-group">
                         <input type="text" name="name_niveauplanification" id="name_niveauplanification" class="form-control" value="{{ old('name_niveauplanification') }}">
                       </div>
