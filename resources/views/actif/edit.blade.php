...
<div class="grid">
    <div class="container" style="margin-top:2%">
        ...
        <div class="row">
         ...
         <form action="{{ url('actif/'.$actif->id) }}" method="post">
            @csrf
                   ...
                   <div class="col form-group">
                       ...
                       <div class="form-group">
                         <select name="wilaya_id" id="wilaya_id" class="form-control">
                                 <option value="{{ $actif->wilaya->id }}">{{ $actif->wilaya->nomwilaya }}</option>
        ...
        <div class="row">
         ...
         <div class="col">
          ...
          <input type="number" name="casasymptomatiquesave" id="asymptomatique" class="form-control" value="{{ $actif->casasymptomatiquesave }}" placeholder="">

         </div>
         <div class="col">
             <label for="" class="col-form-label-lg">{{ __('Cas Simple') }}</label>
          <input type="number" name="cassimplesave" id="cassimple" class="form-control" value="{{ $actif->cassimplesave }}" placeholder="">

         </div>
         <div class="col">
             <label for="" class="col-form-label-lg">{{ __('Cas Avec Complication') }}</label>
          <input type="number" name="casgravesave" id="casaveccomplication" class="form-control" value="{{ $actif->casgravesave }}" placeholder="">
