...
<div class="grid">
    <div class="container" style="margin-top:2%">
        <div class="row bg-white shadow-sm">
            <h4 class="col display-4 text-center">Modifier un Service</h4>
        </div>
            ...
            <div class="container bg-white shadow-sm" style="margin-top:2%; padding-bottom:2%">
               <div class="row">
                   <div class="col">
                         ...
                         <select name="niveauplanification_id" id="niveauplanification_id" class="form-control">
                            <option value="{{$service->niveauplanification->id}}">{{$service->niveauplanification->name_niveauplanification}}</option>
                    ...
                    <div class="col">
                            ...
                            <select name="directioncentrale_id" id="directioncentrale_id" class="form-control">
                                <option value="{{$service->directioncentrale->id}}">{{$service->directioncentrale->name_directioncentrales}}</option>
               ...
               <div class="row">
                           <div class="col">
                                ...
                                <select name="sousdirection_id" id="sousdirection_id" class="form-control">
                                 <option value="{{$service->sousdirection->id}}">{{$service->sousdirection->name_sousdirection}}</option>
                               </select>
                    ...
                    <div class="col">
                                ...
                                <input name="name_service" id="name_service" class="form-control" value="{{$service->name_service}}">
